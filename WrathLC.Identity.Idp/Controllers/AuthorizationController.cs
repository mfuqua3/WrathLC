...
public class AuthorizationController : Controller
{
    ...
    public AuthorizationController(
        ...
        SignInManager<WrathLcUser> signInManager,
        UserManager<WrathLcUser> userManager)
    {
    ...
    public async Task<IActionResult> Authorize()
    {
        ...
        switch (await _applicationManager.GetConsentTypeAsync(application))
        {
            ...
            case ConsentTypes.Explicit when authorizations.Any() && !request.HasPrompt(Prompts.Consent):
                ...
                principal.SetResources(await _scopeManager.ListResourcesAsync(principalScopes).ToListAsync());
                ...
                if (authorization == null)
                {
                    authorization = await _authorizationManager.CreateAsync(
                        ...
                        client: await _applicationManager.GetIdAsync(application) ?? 
                                throw new ArgumentException("Unable to determine client.", nameof(application)),
                        type: AuthorizationTypes.Permanent,
    ...
    [AllowAnonymous]
    [IgnoreAntiforgeryToken]
    [HttpGet("~/connect/token"), HttpPost("~/connect/token")]
