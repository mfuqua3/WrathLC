...
namespace WrathLc.Core.ResourceAccess.Migrations
{
    ...
    [Migration("20220909183901_Add_Characters_and_Wishlists")]
    partial class Add_Characters_and_Wishlists
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WrathLc.Core.ResourceAccess.Entities.Character", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WrathLc.Core.ResourceAccess.Entities.Wishlist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WrathLc.Core.ResourceAccess.Entities.WishlistItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WrathLc.Core.ResourceAccess.Entities.Character", b =>
                {
                    ...
                    b.HasOne("WrathLc.Core.ResourceAccess.Entities.GuildUser", "GuildUser")
                        .WithMany("Characters")
            ...
            modelBuilder.Entity("WrathLc.Core.ResourceAccess.Entities.Wishlist", b =>
                {
                    b.HasOne("WrathLc.Core.ResourceAccess.Entities.Character", "Character")
                        .WithMany()
            ...
            modelBuilder.Entity("WrathLc.Core.ResourceAccess.Entities.WishlistItem", b =>
                {
                    ...
                    b.HasOne("WrathLc.Core.ResourceAccess.Entities.Wishlist", "Wishlist")
